...
class SignUpForm extends Component {
  ...
  searchAgency = () => {
    axios
      .get(`/agency/findby?name=${this.state.companyName}`)
      .then(res => {
        this.setState({
          ...this.state,
          companyArr: res.data
        ...
        <div className="d-flex flex-row justify-content-center mt-5">
          <div className="col-12 col-md-8 col-lg-6 col-xl-3">
            <div className="card p-5">
              <div align="center"><h4>Let's Get Started <span role="img" aria-label="raised_hands">🙌</span></h4></div>
              <form onSubmit={this.signUpValidation}>
                ...
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    name="username"
                    placeholder="Mr Bet on Yourself"
                    className="form-control"
                    autoComplete="name"
