  ...
  contentForAll = () => {
    ...
    return (
      <div className="container mt-3">
        <Helmet>
          <title>
              Assignments & Pre-Construction{this.props.advert.isForRent?" for rent ":" for sale in "}{this.props.advert.city?`${this.props.advert.city}`:" Toronto"}
          </title>
          {/* <link rel="canonical" href="http://mysite.com/example" /> */}
          <meta name="description" content={`Assignments & Pre-Construction${this.props.advert.isForRent?" for rent":" sale "}${this.props.advert.city?` ${this.props.advert.city}`:" Toronto"}${this.props.advert.address?` ${this.props.advert.address}`:""}${this.props.advert.postcode?`, ${this.props.advert.postcode}`:""}`} />
        ...
        <p>{this.props.advert.postcode}</p>
              ...
              {
                  this.props.user &&
                      this.props.user.user.id === this.props.advert.userId ?               <a href={`/edit/x-for-sale/${this.props.advert.id}`}>
                          <button
              ...
              {this.props.user ? (
                this.props.user.user.id !== this.props.advert.userId ? (
                  this.props.isAppointment ? (
                    ...
                    <h4>You've inquired about this listing.</h4>
