...
class AdvertExtras extends Component {
  ...
  render() {
    if (this.props.myAdvert) {
      return (
        <div>
          <h4>This traits will be shown on your listing</h4>
          <p>To remove traits from your listing, just click on it.</p>
          ...
          <hr />
          <div>
            <h4>Traits you can add to your listing</h4>
            <p>
          ...
          <div className="col-12 col-md-12 col-lg-6 col-xl-5">
            <h4>Add new Trait</h4>
            <p>If you can't find one above.</p>
